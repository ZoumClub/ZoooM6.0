...
import { Pencil, Trash2, Plus, Tag, LogOut } from 'lucide-react';
...
export function CarList({ onDelete, onToggleSold, onLogout }: CarListProps) {
                ...
                <tr key={car.id} className={`hover:bg-gray-50 relative ${car.is_sold ? 'opacity-75' : ''}`}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-4">
                      <Link
                        href={`/admin/dashboard/cars/edit/${car.id}`}
