...
import type { Brand, PrivateListing } from '@/lib/supabase';
...
export default function SellYourCarPage({ brands }: SellYourCarPageProps) {
  const [formData, setFormData] = useState<Partial<PrivateListing>>({
    brand_id: '',
    make: '',
    model: '',
