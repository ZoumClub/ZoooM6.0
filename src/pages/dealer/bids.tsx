...
interface ListingWithBid extends PrivateListing {
  highest_bid?: number;
}

export default function DealerBids() {
  const router = useRouter();
  const [listings, setListings] = useState<ListingWithBid[]>([]);
  const [isLoading, setIsLoading] = useState(true);
  const [selectedListing, setSelectedListing] = useState<ListingWithBid | null>(null);
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4">
                    <BidButton
                      ...
                      currentBid={listing.highest_bid}
